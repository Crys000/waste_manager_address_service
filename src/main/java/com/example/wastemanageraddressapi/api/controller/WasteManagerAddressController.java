package com.example.wastemanageraddressapi.api.controller;
...
import com.example.wastemanageraddressapi.dto.WasteManagerAddressDto;
import com.example.wastemanageraddressapi.entity.WasteManagerAddressEntity;
import com.example.wastemanageraddressapi.service.WasteManagerAddressService;
...
public class WasteManagerAddressController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody WasteManagerAddressDto wasteManagerAddressDto, BindingResult bindingResult)
            throws Exception {
    ...
    @PutMapping("/update")
    public ResponseEntity<?> update(@RequestBody WasteManagerAddressDto wasteManagerAddressDto, BindingResult bindingResult)
            throws Exception {
        if (bindingResult.hasErrors()) {
            return new ResponseEntity<>(bindingResult.getAllErrors(), HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> findById(@PathVariable Long addressId) throws Exception {
        try {
            ...
            if (wasteManagerAddressEntity != null) {
                WasteManagerAddressDto wasteManagerAddressDto = modelMapper.map(wasteManagerAddressEntity, WasteManagerAddressDto.class);
    ...
    public ResponseEntity<?> listAll() throws Exception {
        try {
            ...
            List<WasteManagerAddressDto> addressDtos = addresses.stream()
                    .map(address -> modelMapper.map(address, WasteManagerAddressDto.class))
